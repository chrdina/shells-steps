        ...
        <Router basename="/">
          ...
          <div className="navbar">
            ...
            <div className="menu">
              <ul>
                ...
                <li>
                  <NavLink to="/trips" activeClassName="nav-active">
                    Trips
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/countries" activeClassName="nav-active">
                    Countries
                  </NavLink>
                </li>
                <li>
            ...
            <div
              className={`hamburger ${this.state.menuActive ? "open" : null}`}
          ...
          <div
            className={`collapsible-menu ${
              this.state.menuActive ? "collapsible-menu-active" : null
            }`}
          >
            <ul>
              <NavLink
